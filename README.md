...
- **NPM Installation**: Basic installation and configuration of the `mingcute_icon` package.
...
MingCute Icon library is licensed under the [Apache-2.0 License](https://github.com/mingcute-design/mingcute-icons/blob/main/LICENSE).
